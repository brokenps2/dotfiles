...
let g:colors_name = 'bluecontrast'

hi Cursor        guifg=#0B0A17 guibg=#c6d0fb  ctermfg=233 ctermbg=189
hi lCursor       guifg=#0B0A17 guibg=#c6d0fb  ctermfg=233 ctermbg=189
hi CursorIM      guifg=#0B0A17 guibg=#c6d0fb  ctermfg=233 ctermbg=189
hi Directory     guifg=#4fc6db guibg=#0B0A17  ctermfg=238 ctermbg=233 gui=bold
hi ErrorMsg      guifg=#ee1111 guibg=#0B0A17  ctermbg=233
hi VertSplit     guifg=#0c0d18 guibg=#9d73d8  ctermfg=233 ctermbg=239
hi LineNr        guifg=#b2bbe2 guibg=#101120  ctermfg=146 ctermbg=16
hi ModeMsg       guifg=#565f89 guibg=#0B0A17  ctermfg=60 ctermbg=233
hi MoreMsg       guifg=#565f89 guibg=#0B0A17  ctermfg=60 ctermbg=233
hi Normal        guifg=#e0e2ea guibg=#0B0A17  ctermfg=189 ctermbg=233
hi SpellBad      guifg=#ff0000 guibg=#0B0A17  ctermfg=red ctermbg=233 gui=underline cterm=underline
hi Question      guifg=#565f89 guibg=#0B0A17  ctermfg=60 ctermbg=233
...
" status line
hi Title         guifg=#9d73d8 guibg=#0B0A17 gui=bold  ctermfg=239 ctermbg=233
hi Visual        guibg=#141527 gui=none  ctermbg=16
hi VisualNOS     guibg=#0c0d18 ctermbg=233
hi WarningMsg    guifg=#4fc6db guibg=#0B0A17  ctermfg=238 ctermbg=233
hi Number        guifg=#fcaf68 ctermfg=77
hi Char          guifg=#dbffc6 gui=italic ctermfg=194
hi String        guifg=#ff8358 ctermfg=194
...
hi Error         guifg=#ee1111 guibg=#0B0A17  ctermbg=233
...
if version >= 700
  ...
  hi PmenuSel     guifg=#9d73d8 guibg=#0B0A17  ctermfg=239 ctermbg=233
  hi PmenuSbar    guibg=#101120  ctermbg=16

  " Tab
  hi TabLine      guifg=#c6d0fb guibg=#101120 gui=bold  ctermfg=189 ctermbg=16
  hi TabLineFill  guifg=#0c0d18 guibg=#0B0A17 gui=bold  ctermfg=233 ctermbg=233
